...
import { sanitizeSub2APISettingsForPersistence } from './lib/sub2apiIntegration'
...
export function getPersistedState(state: AppState) {
  const settings = sanitizeSub2APISettingsForPersistence(normalizeSettings(state.settings))
